...
const Hero = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-20 lg:px-12 pt-28">
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-10 lg:gap-20">
        <div className="text-white w-full md:w-3/5 space-y-6 text-center md:text-left">
          <div className="space-y-3">
            <h3 className="text-amber-400 font-medium tracking-[0.2em] uppercase text-xs md:text-sm animate-bounce">
